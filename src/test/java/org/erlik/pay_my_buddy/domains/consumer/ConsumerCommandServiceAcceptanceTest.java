...
class ConsumerCommandServiceAcceptanceTest {
    ...
    void createANewConsumerTest() {
        ...
        final var createNewConsumerCommand = new CreateNewConsumerCommand(
            firstname,
            lastname,
            email,
            password);
        ...
        //WHEN
        final var createdConsumerId = consumerCommandService.createConsumer(createNewConsumerCommand);
    ...
    @Test
    @DisplayName("Given a consumer exists when I add a friend then his add to my friends list")
    void addFriend() {
        //GIVEN
